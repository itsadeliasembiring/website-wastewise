    ...
    <section class="text-white py-14 px-7" style="background-color: #3D8D7A;">
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-7">
            <div>
                ...
                <p class="mt-4 text-base text-justify [text-align:justify]">Yuk manfaatkan fitur ini untuk mengenal lebih jauh tentang sampah yang kamu hasilkan. Cukup pindai sampah yang ingin kamu ketahui dan dapatkan informasi lengkapnya.</p>
                <a href="#" class="mt-6 inline-block font-semibold px-5 py-2 border-2 border-white rounded-md hover:bg-white hover:text-green-700 transition">Kenali Sekarang</a>
            </div>
